  ...
  static tournaments = [
    {
      ...
      nameKey: "Core BDL 1v1 Duels",
      descriptionKey: "(.gg/sgcore) - Compete in free-for-all matches, be the last one standing to win!",
...
colourData: {
  ...
  infoWidgetsBorderColour: "#6FD0FF"
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 5 * 365 * 24 * 60 * 60 * 1000),
      nameKey: "Core BD 1v1 Duels",
      descriptionKey: "(.gg/sgcore) - Fast 1v1 duels. Pure skill. Only victory.",
...
colourData: {
  ...
  infoWidgetsBorderColour: "#328bffff"
    ...
    },
    {
      ...
      startTime: new Date(),
      endTime: new Date(Date.now() + 5 * 365 * 24 * 60 * 60 * 1000),
      nameKey: "Core RH 1v1 Duels",
      descriptionKey: "(.gg/sgcore) - Win, Farps and be the best",
